    ...
    public function index(Request $request)
    {
        ...
        if ($id_proyecto != null) {
          ...
          if( $id_proyecto==1){
            ...
            try{
                $file1 = fopen('../scripts/arch/datos_wd', 'r');       
                $d1 = stream_get_line($file1, filesize('../scripts/arch/datos_wd'));
              ...
              try{
                  $file2 = fopen('../scripts/arch/datos_heat_so2', 'r');       
                  $d2 = stream_get_line($file2, filesize('../scripts/arch/datos_heat_so2'));
                  $array_qual_data_values_p=$d2;
                    ...
                    $poslat_map = '-32.83994675';
                    $poslong_map = '-71,5766525268554';

            try{
                $file1 = fopen('../scripts/arch/datos_wd_codelco', 'r');       
                $d1 = stream_get_line($file1, filesize('../scripts/arch/datos_wd_codelco'));
                $array_meteo_data_values_p=$d1;
                } catch (Exception $e) {
                      $array_meteo_data_values_p='{}';
                  }
                  ...
                  try{
                    $file2 = fopen('../scripts/arch/datos_heat_codelco', 'r');       
                    $d2 = stream_get_line($file2, filesize('../scripts/arch/datos_heat_codelco'));
                    $array_qual_data_values_p=$d2;
                        } catch (Exception $e) {
                            $array_qual_data_values_p='{}';
                          }
            ...
            if ($estaciones_list->count() != 0) {
                ...
                if ($estacion->count() > 0) {
                    ...
                    $position_maps='-33.44476474432827, -70.6606760759421';
                }

                if($id_proyecto==2){
                    $poslat_map = '-32.762077';
                    $poslong_map = '-71.491070';

                    $position_maps='-32.762077, -71.491070';
                }
