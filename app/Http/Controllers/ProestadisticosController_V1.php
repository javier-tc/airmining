...
class ProestadisticosController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
                ...
                // estadisticos
                //-----------------------------------------------------------------------------------------------------
                $margarita_stat_ayer = DB::table('registros')
            ...
            DATE_FORMAT(fc_creacion,'%H') as hr_creacion,DATE_FORMAT(fc_creacion,'%H') as hr"))
                ...
                $margarita_stat_hoy = DB::table('registros')
                    ->select(DB::raw("*,DATE_FORMAT(fc_creacion,'%Y-%m-%d') as fc_creacion,
            DATE_FORMAT(fc_creacion,'%H') as hr_creacion,DATE_FORMAT(fc_creacion,'%H') as hr"))
                    ->where('id_estacion', '=', $estacion_id)   //margarita
                ...
                $margarita_stat_manana = DB::table('registros')
                    ->select(DB::raw("*,DATE_FORMAT(fc_creacion,'%Y-%m-%d') as fc_creacion,
            DATE_FORMAT(fc_creacion,'%H') as hr_creacion,DATE_FORMAT(fc_creacion,'%H') as hr"))
                    ->where('id_estacion', '=', $estacion_id)   //margarita
                ...
                $margarita_stat_pasado = DB::table('registros')
                    ->select(DB::raw("*,DATE_FORMAT(fc_creacion,'%Y-%m-%d') as fc_creacion,
            DATE_FORMAT(fc_creacion,'%H') as hr_creacion,DATE_FORMAT(fc_creacion,'%H') as hr"))
                    ->where('id_estacion', '=', $estacion_id)   //margarita
                ...
                $data_stat = '{"' . $ayer . '":{';
                $range_stat = '{"' . $ayer . '":{';
                foreach ($margarita_stat_ayer as $key => $mar) {
                ...
                foreach ($margarita_stat_ayer as $key => $mar2) {
                ...
                foreach ($margarita_stat_manana as $key => $mar3) {
                ...
                foreach ($margarita_stat_pasado as $key => $mar4) {
