...
*/
         ...
         */
                // NEURONAL
                //-----------------------------------------------------------------------------------------------------
                $margarita_neu_ayer = DB::table('registros')
                ...
                $margarita_neu_hoy = DB::table('registros')
                    ->select(DB::raw("*,DATE_FORMAT(fc_creacion,'%Y-%m-%d') as fc_creacion,
            DATE_FORMAT(fc_creacion,'%H') as hr_creacion,DATE_FORMAT(fc_creacion,'%H') as hr"))
                    ->where('id_estacion', '=', $estacion_id)   //margarita
                ...
                $margarita_neu_manana = DB::table('registros')
                    ->select(DB::raw("*,DATE_FORMAT(fc_creacion,'%Y-%m-%d') as fc_creacion,
            DATE_FORMAT(fc_creacion,'%H') as hr_creacion,DATE_FORMAT(fc_creacion,'%H') as hr"))
                    ->where('id_estacion', '=', $estacion_id)   //margarita
                ...
                $margarita_neu_pasado = DB::table('registros')
                    ->select(DB::raw("*,DATE_FORMAT(fc_creacion,'%Y-%m-%d') as fc_creacion,
            DATE_FORMAT(fc_creacion,'%H') as hr_creacion,DATE_FORMAT(fc_creacion,'%H') as hr"))
                    ->where('id_estacion', '=', $estacion_id)   //margarita
                ...
                $data_neu = '{"' . $ayer . '":{';
                $range_neu = '{"' . $ayer . '":{';
                foreach ($margarita_neu_ayer as $key => $mar) {
                ...
                foreach ($margarita_neu_hoy as $key => $mar2) {
                ...
                foreach ($margarita_neu_manana as $key => $mar3) {
                ...
                foreach ($margarita_neu_pasado as $key => $mar4) {
