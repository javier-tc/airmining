...
class ProneuronalesController extends Controller
{
...
*/
         ...
         */
                // NEURONAL
                //-----------------------------------------------------------------------------------------------------
                    $estacion_neu_ayer = DB::table('registros')
                    ...
                    $estacion_neu_hoy = DB::table('registros')
                    ->select(DB::raw("*,DATE_FORMAT(fc_creacion,'%Y-%m-%d') as fc_creacion,
                    DATE_FORMAT(fc_creacion,'%H') as hr_creacion,DATE_FORMAT(fc_creacion,'%H') as hr"))
                    ->where('id_estacion', '=', $estacion_id)   //margarita
                ...
                //dd($margarita_neu_hoy);
                    ...
                    $estacion_neu_manana = DB::table('registros')
                    ->select(DB::raw("*,DATE_FORMAT(fc_creacion,'%Y-%m-%d') as fc_creacion,
                    DATE_FORMAT(fc_creacion,'%H') as hr_creacion,DATE_FORMAT(fc_creacion,'%H') as hr"))
                    ->where('id_estacion', '=', $estacion_id)   //margarita
                ...
                // dd($margarita_neu_manana);
                    ...
                    $estacion_neu_pasado = DB::table('registros')
                    ->select(DB::raw("*,DATE_FORMAT(fc_creacion,'%Y-%m-%d') as fc_creacion,
                    DATE_FORMAT(fc_creacion,'%H') as hr_creacion,DATE_FORMAT(fc_creacion,'%H') as hr"))
                    ->where('id_estacion', '=', $estacion_id)   //margarita
                    ...
                    if ($id_proyecto==2){
                        $data_neu = '{"' . $ayer . '":{';
                            $range_neu = '{"' . $ayer . '":{';
                            foreach ($estacion_neu_ayer as $key => $mar) {
                                if ($mar->hr_creacion == 23) {
                                    $data_neu = $data_neu . '"time_' . $mar->hr_creacion . '":"' . $mar->dato . '"';
                                    $range_neu = $range_neu . '"time_' . $mar->hr_creacion . '":"' . $mar->range . ' ['.round($mar->dato).']"';
                                } else {
                                    $data_neu = $data_neu . '"time_' . $mar->hr_creacion . '":"' . $mar->dato . '",';
                                    $range_neu = $range_neu . '"time_' . $mar->hr_creacion . '":"' . $mar->range . ' ['.round($mar->dato).']",';
                                }
                            ...
                            foreach ($estacion_neu_hoy as $key => $mar2) {
                                if ($mar2->hr_creacion == 23) {
                                    $data_neu = $data_neu . '"time_' . $mar2->hr_creacion . '":"' . $mar2->dato . '"';
                                    $range_neu = $range_neu . '"time_' . $mar2->hr_creacion . '":"' . $mar2->range . ' ['.round($mar2->dato).']"';
                                } else {
                                    $data_neu = $data_neu . '"time_' . $mar2->hr_creacion . '":"' . $mar2->dato . '",';
                                    $range_neu = $range_neu . '"time_' . $mar2->hr_creacion . '":"' . $mar2->range . ' ['.round($mar2->dato).']",';
                                }
                            ...
                            foreach ($estacion_neu_manana as $key => $mar3) {
                                if ($mar3->hr_creacion == 23) {
                                    $data_neu = $data_neu . '"time_' . $mar3->hr_creacion . '":"' . $mar3->dato . '"';
                                    $range_neu = $range_neu . '"time_' . $mar3->hr_creacion . '":"' . $mar3->range . ' ['.round($mar3->dato).']"';
                                } else {
                                    $data_neu = $data_neu . '"time_' . $mar3->hr_creacion . '":"' . $mar3->dato . '",';
                                    $range_neu = $range_neu . '"time_' . $mar3->hr_creacion . '":"' . $mar3->range . ' ['.round($mar3->dato).']",';
                                }
                            ...
                            foreach ($estacion_neu_pasado as $key => $mar4) {
                                if ($mar4->hr_creacion == 23) {
                                    $data_neu = $data_neu . '"time_' . $mar4->hr_creacion . '":"' . $mar4->dato . '"';
                                    $range_neu = $range_neu . '"time_' . $mar4->hr_creacion . '":"' . $mar4->range . ' ['.round($mar4->dato).']"';
                                } else {
                                    $data_neu = $data_neu . '"time_' . $mar4->hr_creacion . '":"' . $mar4->dato . '",';
                                    $range_neu = $range_neu . '"time_' . $mar4->hr_creacion . '":"' . $mar4->range . ' ['.round($mar4->dato).']",';
                                }
                ...
                return view('pronosticos.neuronales', compact(
                    'ayer',
                    'manana',
                    'first_datetime',
                    'timeInterval',
