...
use App\Models\ThirdNumericos;
use Maatwebsite\Excel\Concerns\ToModel;

class ThirdNumericosImport implements ToModel
{
    ...
    public function model(array $row)
    {
        ...
        */
        ...
        else if ($row[1]>=100 and $row[1]<=200) {$rangeso2="entre 100,00 - 200,00";$alerta=2;}
        else if ($row[1]>200 and $row[1]<=300) {$rangeso2="entre 200,00 - 300,00";$alerta=3;}
        else if ($row[1]>300 and $row[1]<=400){ $rangeso2="entre 300,00 - 400,00";$alerta=4;}
        else if ($row[1]>400) {$rangeso2="más de 400,00";$alerta=5;}
