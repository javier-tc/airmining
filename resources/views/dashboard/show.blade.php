						...
						<table class="table table-bordered mb0">
							<tbody>
								...
								<tr>
									...
									@ENDIF
									<td style="width: 33%;" class="text-center"><strong>{{$sinopticos[0]->sin_dat1}}</strong></td>
								</tr>
								<tr>
									...
									@ENDIF
									<td style="width: 33%;" class="text-center"><strong>{{$sinopticos[0]->sin_dat2}}</strong></td>
								</tr>
								<tr>
									...
									@ENDIF
									<td style="width: 33%;" class="text-center"><strong>{{$sinopticos[0]->sin_dat3}}</strong></td>
								</tr>
							</tbody>
						</table>
					</div>
