								...
								<tr>
									<td style="width: 50%; padding: 0px; padding-left: 5px;">
										<div class="col-sm-12 col-md-12 col-lg-12 p0" style="line-height: 15px;">
											...
											@if ($estacion4->count()!=0)
											WS: {{$estacion4[0]->num_rangews}}- m/s
											@else
											WS: - m/s
											@endif
									...
									<td style="width: 50%; padding: 0px; padding-left: 5px;">
										...
										<div class="col-sm-12 col-md-12 col-lg-12 p0" style="line-height: 15px;">
											...
											@if ($estacion4->count()!=0)
											SO2: {{$estacion4[0]->num_rangeso2}}- µg/m3
											@else
											SO2: - µg/m3
											@endif
										...
										<div class="col-sm-12 col-md-12 col-lg-12 p0" style="line-height: 15px;">
											...
											<label style="font-size: 13px; display: inline;">
											@if ($estacion4->count()!=0)
											PM10: {{$estacion4[0]->num_rangepm10}}- µg/m3
											@else
											PM10: - µg/m3
											@endif
										</label>
