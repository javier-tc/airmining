...
@endforeach
					...
					<div id="div_stat_model" class="panel panel-default mb15" style="display: none">
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		// Si el Sector tiene el modelo Numérico (id 3)
			...
			// Inicia Mapa Leaflet
			//var map = L.map('map').setView([-32.8061616, -70.9586498], 300);   $poslat_map = '-32.83994675';  $poslong_map = '-71,5766525268554';
			
			var map = new L.Map('mapa', {
				//center : new L.LatLng(-32.8061616, -70.9586498), // Posicionamiento del mapa
				center : new L.LatLng({!!$position_maps!!}), // Posicionamiento del mapa
				zoom: 12,
				timeDimension: true,
            ...
            var array_qual_data_values_p ={!!$array_qual_data_values_p!!};

			
// Datos variable inicial de tipo "Meteorológica" (para el layer de Arrow)
var array_meteo_data_values_p ={!!$array_meteo_data_values_p!!};
